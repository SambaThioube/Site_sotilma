...
const productDetails: Record<string, { longDesc: string; features: string[]; featureItems?: { title: string; desc: string }[] }> = {
  ...
  "camera-agricole-v-pro-plus": { longDesc: "La caméra agricole 4G version lampe est conçue pour la surveillance continue des exploitations, même en zones reculées. Elle fonctionne à l'énergie solaire et transmet les images directement sur votre téléphone.", features: ["Vision HD 24/7", "100% solaire", "Transmission 4G", "Surveillance continue", "Installation simple", "Résistance aux intempéries", "Alertes en temps réel", "Garantie 6 mois", "Avec éclairage"] },
